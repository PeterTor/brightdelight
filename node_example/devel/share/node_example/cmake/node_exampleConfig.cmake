...
if("TRUE" STREQUAL "TRUE")
  set(node_example_SOURCE_PREFIX /home/megatron/node_example)
  set(node_example_DEVEL_PREFIX /home/megatron/node_example/devel)
...
if(NOT "/home/megatron/node_example/devel/include " STREQUAL " ")
  set(node_example_INCLUDE_DIRS "")
  set(_include_dirs "/home/megatron/node_example/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'node_example' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/megatron/node_example/${idir}'.  Ask the maintainer 'Thomas Denewiler <tdenewiler@gmail.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/megatron/node_example/devel/lib;/opt/ros/indigo/lib)
